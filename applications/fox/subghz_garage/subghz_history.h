 ...
 * @param instance  - SubGhzHistory instance
 * @param output    - FuriString* output
 * @param threshold - free-heap floor for "RAM almost FULL" (SUBGHZ_LOW_RAM_
 *                    FREE_HEAP_READ from a CLI-lock-list caller, SUBGHZ_
 *                    LOW_RAM_FREE_HEAP otherwise - see subghz_i.h)
 * @return bool - is FULL
 */
 ...
 * @param threshold - free-heap floor below which the add is refused (see
 *                    subghz_history_get_text_space_left()'s own doc)
 * @return bool;
 */
