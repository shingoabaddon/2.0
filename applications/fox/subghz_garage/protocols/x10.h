 ...
 * @return void* pointer to a SubGhzProtocolEncoderX10 instance
 */
...
/**
 * Deserialize and start encoding SubGhzProtocolEncoderX10 - X10 is a fixed
 * (non-rolling) code, so this just re-emits the exact bit pattern that was
 * decoded/saved, same as replaying a raw capture.
 * @param context Pointer to a SubGhzProtocolEncoderX10 instance
...
/**
 * Stop encoding SubGhzProtocolEncoderX10.
 * @param context Pointer to a SubGhzProtocolEncoderX10 instance
 */
