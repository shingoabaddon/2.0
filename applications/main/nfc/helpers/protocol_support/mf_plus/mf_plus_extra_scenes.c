...
static void mf_plus_scene_update_initial_on_enter(NfcApp* instance) {
    ...
    // [NO_ICON] popup_set_icon(popup, 0, 8, &I_NFC_manual_60x50); - nfc_icons.h isn't visible from
    // this file's plugin build context (helpers/protocol_support/mf_plus is its own fal_embedded app)
