 ...
 *
 * Derives per-sector keys from the tag UID (HKDF / HMAC-SHA256, self-
 * contained - no new firmware crypto dependencies) and renders material
 * type, color, filament code, production date, temperatures and spool
 * specs.
 *
 * Port of https://github.com/uzyn/flipper-bambu (GPL-3.0), by U-Zyn Chua.
 * Filament DB credit: https://github.com/queengooborg/Bambu-Lab-RFID-Library
 * Tag-format research: https://github.com/Bambu-Research-Group/RFID-Tag-Guide
 *
 * Copyright 2026 U-Zyn Chua
 *
