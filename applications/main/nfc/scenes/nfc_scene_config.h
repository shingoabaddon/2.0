...
ADD_SCENE(nfc, update_initial_success, UpdateInitialSuccess)
ADD_SCENE(nfc, update_initial_wrong_card, UpdateInitialWrongCard)
...
ADD_SCENE(nfc, mf_plus_more_info, MfPlusMoreInfo)
ADD_SCENE(nfc, mf_plus_iso4_info, MfPlusIso4Info)
ADD_SCENE(nfc, mf_plus_version, MfPlusVersion)
ADD_SCENE(nfc, mf_plus_update_initial, MfPlusUpdateInitial)
