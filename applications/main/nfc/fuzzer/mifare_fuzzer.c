...
/// @param nfc Nfc instance already owned by the caller, reused for the
/// fuzzer's worker instead of allocating a second, conflicting one.
/// @return
...
/// @brief fuzzer_mifare_run - runs the Mifare Fuzzer as a nested blocking sub-app
